...
import { getShowSubscriptionTransaction } from "@/core/services/subscription/subscription.service";
...
const RevenueChart = ({ showId }: RevenueChartProps) => {
  ...
  const fetchSubscriptionTransactionList = async () => {
    setIsLoading(true);
    try {
      const res = await getShowSubscriptionTransaction(loginRequiredAxiosInstance, showId);
    ...
    <div className="revenue-chart">
      <div className="revenue-chart__header">
        <div className="flex justify-center gap-2 items-center">
          <h3 className="revenue-chart__title ">Revenue Statistics from this Show</h3>
