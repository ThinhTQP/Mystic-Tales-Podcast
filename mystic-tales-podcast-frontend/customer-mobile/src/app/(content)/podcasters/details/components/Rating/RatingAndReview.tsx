...
import { PodcasterReviewAPI } from "@/src/core/types/podcaster.type";
...
const RatingCard = ({ rating }: { rating: PodcasterReviewAPI }) => {
        ...
        <View style={styles.reviewUser}>
          <View style={styles.userInfo}>
            ...
            <Text style={styles.reviewDate}>
              {formatDate(rating.UpdatedAt as string)}
            </Text>
          </View>
        </View>
