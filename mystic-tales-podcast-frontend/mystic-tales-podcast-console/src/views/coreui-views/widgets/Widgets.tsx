...
import DocsExample from '../../components/layout/DocsExample'
...
const Widgets = () => {
  ...
  return (
    <CCard className="mb-4">
      ...
      <CCardBody>
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatsa">
          <WidgetsDropdown />
        </DocsExample>
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatsb">
          <CRow xs={{ gutter: 4 }}>
        ...
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatse">
          <CRow xs={{ gutter: 4 }}>
            <CCol sm={4} md={3} xl={2}>
              <CWidgetStatsE
                chart={
        ...
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatsf">
          <CRow xs={{ gutter: 4 }}>
            <CCol xs={12} sm={6} xl={4} xxl={3}>
              <CWidgetStatsF
        ...
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatsd">
          <WidgetsBrand />
        </DocsExample>
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatsd">
          <WidgetsBrand withCharts />
        </DocsExample>
        <DocsExample tabContentClassName={null}  href="components/widgets/#cwidgetstatsc">
