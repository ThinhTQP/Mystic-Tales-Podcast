      ...
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#single-button">
              <CDropdown>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#split-button">
              <>
                {['primary', 'secondary', 'success', 'info', 'warning', 'danger'].map(
                  (color, index) => (
                    <CDropdown variant="btn-group" key={index}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#sizing">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#dark-dropdowns">
              <CDropdown dark>
                <CDropdownToggle color="secondary">Dropdown button</CDropdownToggle>
                <CDropdownMenu>
                  <CDropdownItem href="#">Action</CDropdownItem>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#dropup">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#dropright">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/dropdown#dropleft">
              <CButtonGroup>
