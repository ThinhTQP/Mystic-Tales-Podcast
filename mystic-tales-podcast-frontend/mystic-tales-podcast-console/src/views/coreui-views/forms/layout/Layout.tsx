      ...
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#form-grid">
              <CRow>
                <CCol xs>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#gutters">
              <CRow className="g-3">
                <CCol xs>
                  <CFormInput placeholder="First name" aria-label="First name" />
                </CCol>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#horizontal-form">
              <CForm>
                <CRow className="mb-3">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#horizontal-form-label-sizing">
              <CRow className="mb-3">
                <CFormLabel
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#column-sizing">
              <CRow className="g-3">
                <CCol sm={7}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#auto-sizing">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="forms/layout#inline-forms">
