...
import DocsComponents from '../../../components/layout/defualt-layout/DocsComponents'
import DocsExample from '../../../components/layout/defualt-layout/DocsExample'
      ...
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#body">
              <CCard>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#titles-text-and-links">
              <CCard style={{ width: '18rem' }}>
                <CCardBody>
                  <CCardTitle>Card title</CCardTitle>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#images">
              <CCard style={{ width: '18rem' }}>
                <CCardImage orientation="top" src={ReactImg} />
                <CCardBody>
                  <CCardText>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#list-groups">
              <CRow>
                <CCol lg={4}>
                  <CCard>
                    <CListGroup flush>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#kitchen-sink">
              <CCard style={{ width: '18rem' }}>
                <CCardImage orientation="top" src={ReactImg} />
                <CCardBody>
                  <CCardTitle>Card title</CCardTitle>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#header-and-footer">
              <CCard>
                <CCardHeader>Header</CCardHeader>
                <CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#sizing">
              <CRow>
                <CCol sm={6}>
                  <CCard>
                    <CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#text-alignment">
              <CCard style={{ width: '18rem' }}>
                <CCardBody>
                  <CCardTitle>Special title treatment</CCardTitle>
                  <CCardText>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/##navigation">
              <CCard className="text-center">
                <CCardHeader>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#image-caps">
              <CRow>
                <CCol lg={6}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#background-and-color">
              <CRow>
                {[
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#border">
              <CRow>
                {[
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#top-border">
              <CRow>
                {[
                  { color: 'primary', textColor: 'primary' },
                  { color: 'secondary', textColor: 'secondary' },
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#card-groups">
              <CCardGroup>
                <CCard>
                  <CCardImage orientation="top" src={ReactImg} />
                  <CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/card/#grid-cards">
