    ...
    <CRow>
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/collapse">
              <CButton
                color="primary"
                href="#"
                onClick={(e) => {
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">You can use a link or a button component.</p>
            <DocsExample tabContentClassName={null}  href="components/collapse#horizontal">
              <CButton
                className="mb-3"
                color="primary"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/collapse#multiple-targets">
