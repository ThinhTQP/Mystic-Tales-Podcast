...
const ExampleToast: FC = () => {
  ...
  return (
    <>
      <CButton color="primary" onClick={handleAddToast}>
        Send a toast
      </CButton>
      <CToaster ref={toaster} push={toast as any} placement="top-end" />
    </>
  )
}
      ...
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/toast">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/toast#stacking">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/toast#custom-content">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample tabContentClassName={null}  href="components/toast#color-schemes">
              <CToast
                autohide={false}
                color="primary"
