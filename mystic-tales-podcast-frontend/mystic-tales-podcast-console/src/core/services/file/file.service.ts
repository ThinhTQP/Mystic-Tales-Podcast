...
const PODCAST_SERVICE_URL = "podcast-service/api/misc";
...
export const getPublicSourcePodcast = async (instance: AxiosInstance, fileKey: string) => {

    const response = await callAxiosRestApi({
        instance: instance,
        method: "get",
        url: `${PODCAST_SERVICE_URL}/public-source/get-file-url/${fileKey}`,
    });
